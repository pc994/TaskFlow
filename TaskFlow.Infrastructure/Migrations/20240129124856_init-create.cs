    ...
    public partial class initcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskAuditableModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskAuditableModels_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAuditableModels_TaskId",
                table: "TaskAuditableModels",
                column: "TaskId",
                unique: true);
